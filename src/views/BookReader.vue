...
<select @change="changeFont($event.target.value)" class="font-selector">
  ...
  <div id="hs-overlay-right" class="hs-overlay hs-overlay-open:translate-x-0 hidden translate-x-full fixed top-0 end-0 transition-all duration-300 transform max-w-xs w-full z-[4800] bg-white border-s dark:bg-neutral-800 dark:border-neutral-700 flex flex-col h-screen" tabindex="-1">
    <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700 flex-shrink-0">
    ...
    <div class="toc-container flex-grow overflow-y-auto p-4">
